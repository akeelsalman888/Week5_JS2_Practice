...
switch(studentGrade){
    ...
    case 4:
    case 5:
        console.log("Elementary"); break;
    case 6:
    case 7:
         console.log("Middle"); break; 
    case 9: console.log("Freshman"); break;
    case 10: console.log("Sophomore"); break;
    case 11: console.log("Junior"); break;
    case 12: console.log("Senior"); break;
...
//Answer: because the condition will always true, and wil cause infinite loop
